...
from models.FTUNetFormer import ft_unetformer
...
def get_cfg(dataset_name=None):
    ...
    model = ft_unetformer(num_classes=len(labels), decoder_channels=256)
    ...
    optimizer = optim.AdamW(param_groups, weight_decay=2.5e-4)
