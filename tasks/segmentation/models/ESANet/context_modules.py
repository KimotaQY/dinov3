...
def get_context_module(context_module_name,
                       channels_in,
                       channels_out,
                       input_size,
                       activation,
    ...
    if 'appm' in context_module_name:
        ...
        if context_module_name == 'ppm-1-2-4-8':
            ...
            bins = (1, 5)
        context_module = PyramidPoolingModule(channels_in,
                                              channels_out,
                                              bins=bins,
                                              activation=activation,
                                              upsampling_mode=upsampling_mode)
...
class PyramidPoolingModule(nn.Module):
    ...
    def __init__(self,
        ...
        self.final_conv = ConvBNAct(in_dim_last_conv,
                                    out_dim,
                                    kernel_size=1,
                                    activation=activation)
