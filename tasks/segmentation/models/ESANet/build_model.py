...
from .model_one_modality import ESANetOneModality
...
def build_model(args, n_classes):
    ...
    if args.pretrained_scenenet != '':
        ...
        keys_to_ignore = [
            k for k in weights_scenenet if 'out' in k
            or 'decoder.upsample1' in k or 'decoder.upsample2' in k
        ]
        ...
        print(
            f'Loaded pretrained SceneNet weights: {args.pretrained_scenenet}')
