...
class ArgumentParserRGBDSegmentation(argparse.ArgumentParser):
    ...
    def set_common_args(self):
        ...
        # pretraining
        self.add_argument('--pretrained_scenenet',
                          default='',
        ...
        self.add_argument('--finetune',
                          default=None,
                          type=str,
                          help='path to the weights you want to finetune on.')
        self.add_argument('--freeze',
                          default=0,
                          type=int,
        ...
        self.add_argument('--batch_size_valid',
                          type=int,
                          default=None,
        ...
        self.add_argument('--optimizer',
                          ...
                          default='Adam',
                          choices=['SGD', 'Adam'])
        self.add_argument('--class_weighting',
                          type=str,
        ...
        self.add_argument('--encoder_block',
                          type=str,
        ...
        self.add_argument('--nr_decoder_blocks',
                          type=int,
                          default=[3],
                          nargs='+',
        ...
        self.add_argument('--encoder_depth',
                          type=str,
                          default=None,
        ...
        self.add_argument('--modality',
                          ...
                          ' respectively.')
        self.add_argument('--encoder_decoder_fusion',
                          type=str,
                          default='add',
                          choices=['add', 'None'],
        ...
        self.add_argument('--dataset',
                          default='nyuv2',
                          choices=[
                              'sunrgbd', 'nyuv2', 'cityscapes',
                              'cityscapes-with-depth', 'scenenetrgbd'
                          ])
        self.add_argument(
            '--dataset_dir',
            default=None,
