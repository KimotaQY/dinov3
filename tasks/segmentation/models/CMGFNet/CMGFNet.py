...
from .GFM import Gated_Fusion
from .R_DSC import decoder_block
...
class FuseNet(nn.Module):
    ...
    def __init__(self, num_classes, pretrained=False, is_deconve=False):
        ...
        self.resnet_features = torchvision.models.resnet34(
            pretrained=pretrained)

        self.enc_rgb1 = nn.Sequential(
            self.resnet_features.conv1,
